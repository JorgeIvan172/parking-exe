...
def generar_pdf_dashboard(user_name, opening_time, closing_time, duration_hours, total_efectivo, total_generados, total_cerrados):
    ...
    pdf.cell(200, 10, txt=f"Tickets generados: {total_generados}", ln=True)
    pdf.cell(200, 10, txt=f"Tickets cerrados: {total_cerrados}", ln=True)
